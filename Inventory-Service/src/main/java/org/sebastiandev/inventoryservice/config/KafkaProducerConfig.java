...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, InventoryCreatedEvent> kafkaTemplate() {
        ...
        DefaultKafkaProducerFactory<String, InventoryCreatedEvent> producerFactory = new DefaultKafkaProducerFactory<>(props);
